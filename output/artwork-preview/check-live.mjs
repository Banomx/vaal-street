...
await send('Page.navigate',{url:'https://banomx.github.io/vaal-street/'});
...
for(const game of ['poe1','poe2']){
 ...
 await writeFile(new URL(`./live-${game}-desktop.png`,import.meta.url),Buffer.from(shot.data,'base64'));
 ...
 await writeFile(new URL(`./live-${game}-mobile.png`,import.meta.url),Buffer.from(mobile.data,'base64'));
