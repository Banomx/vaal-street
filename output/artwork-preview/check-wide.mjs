...
for(const game of ['poe1','poe2']){
 ...
 await writeFile(new URL(`./continuous-wide-${game}-desktop.png`,import.meta.url),Buffer.from(shot.data,'base64'));
 ...
 await writeFile(new URL(`./continuous-wide-${game}-mobile.png`,import.meta.url),Buffer.from(mobile.data,'base64'));
