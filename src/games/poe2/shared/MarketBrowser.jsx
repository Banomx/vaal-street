...
.p2mb-search input{box-sizing:border-box;width:100%;min-width:0;padding:9px;border:1px solid #513022;border-radius:5px;background:#0d0908;color:#e2e2e0}
...
.p2mb-categories em,.p2mb-results header em{flex:0 0 auto;color:#e2e2e0;font-size:12.5px;font-style:normal}
.p2mb-categories button.on em{color:#e2e2e0}
.p2mb-subcategories{margin:1px 0 3px 10px;padding-left:7px;border-left:1px solid #3c271e}
.p2mb-subcategories button{padding:5px 7px;color:#e2e2e0;font-size:12.5px}
...
.p2mb-items button:hover{background:#190f0c;color:#e2e2e0}
.p2mb-items button.on{border-left-color:#d25d32;background:#23130e;color:#e2e2e0}
