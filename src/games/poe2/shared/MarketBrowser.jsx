...
.p2mb-categories button:hover{background:#1a0e0d}
.p2mb-categories>.p2mb-category-branch>button.on{border-color:#712b28;background:#281110;color:#f0a09e}
...
.p2mb-subcategories{margin:1px 0 3px 10px;padding-left:7px;border-left:1px solid #3c201f}
.p2mb-subcategories button{padding:5px 7px;color:#e2e2e0;font-size:12.5px}
.p2mb-subcategories button.on{background:#1e0f0e;color:#e89d9a}
