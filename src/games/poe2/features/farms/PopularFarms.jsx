...
.p2pf-grid{grid-template-columns:repeat(auto-fill,minmax(min(100%,480px),1fr))}.p2pf-card>header{padding-bottom:10px}.p2pf-verdict{display:grid;text-align:right}.p2pf-verdict span{color:#75645c;font-size:9px;letter-spacing:.1em;text-transform:uppercase}.p2pf-verdict strong{font-size:11.5px}.p2pf-verdict.gain strong{color:#79bd72}.p2pf-verdict.loss strong{color:#d9705c}.p2pf-verdict.flat strong{color:#d2a563}.p2pf-decision{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));margin:0 16px 9px;overflow:hidden;border:1px solid #412b22;border-radius:7px;background:#0d0908}.p2pf-decision>div{display:grid;align-content:start;min-width:0;gap:3px;padding:10px 11px;border-right:1px solid #35231c}.p2pf-decision>div:last-child{border-right:0}.p2pf-decision span{color:#987063;font-size:8.5px;font-weight:700;letter-spacing:.1em;text-transform:uppercase}.p2pf-decision strong{overflow:hidden;color:#f0d8cb;font-size:16px;font-variant-numeric:tabular-nums;text-overflow:ellipsis;white-space:nowrap}.p2pf-decision small{color:#a38b7f;font-size:11px;line-height:1.45}.p2pf-decision strong.gain,.p2pf-decision small.gain{color:#79bd72}.p2pf-decision strong.loss,.p2pf-decision small.loss{color:#d9705c}@media(max-width:720px){.p2pf-summary{grid-template-columns:1fr}.p2pf-summary>div{border-right:0;border-bottom:1px solid #302019}.p2pf-summary>div:last-child{border-bottom:0}.p2pf-grid{grid-template-columns:1fr}}@media(max-width:620px){.p2pf-decision{grid-template-columns:repeat(2,minmax(0,1fr))}.p2pf-decision>div:nth-child(2){border-right:0}.p2pf-decision>div:nth-child(-n+2){border-bottom:1px solid #35231c}}
`;
