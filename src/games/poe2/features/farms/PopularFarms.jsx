    ...
    <section className="p2pf-grid">
      {sorted.map((row, index) => {
        ...
        return <article className="p2pf-card" key={row.id} style={{ "--tone": TONES[row.id] || "#bd6846" }}>
          ...
          {row.id === "expedition" && <p className="p2pf-note">{EXPEDITION_ENTRY_NOTE}</p>}
...
const css = `
.p2pf-evidence{margin:0 16px 9px;padding:7px 9px;border:1px solid #443020;border-radius:5px;color:#c7baaf;font-size:10px;line-height:1.5}.p2pf-evidence.limited{border-color:#70502d;color:#d9b787}.p2pf-evidence.active{border-color:#36553b;color:#a9c3a5}
.p2pf-main{display:grid;gap:14px}.p2pf-head{display:grid;gap:22px;padding:20px 22px;border:1px solid #3e281e;border-radius:8px;background:linear-gradient(105deg,#17100d,#0d0908)}.p2pf-head>div:first-child>span,.p2pf-tool>span{color:#deb3a2;font-size:10.5px;font-weight:700;letter-spacing:.12em;text-transform:uppercase}.p2pf-head h2{margin:4px 0;color:#f0ded5;font-size:27px}.p2pf-head p{max-width:700px;margin:0;color:#c7bab5;font-size:13.5px}.p2pf-tools{display:flex;align-items:flex-end;gap:16px;flex-wrap:wrap;padding-top:16px;border-top:1px solid #39291f}.p2pf-tool{display:grid;gap:5px}.p2pf-ranges button,.p2pf-sort button{padding:6px 10px}.p2pf-adjust{display:flex;align-items:center;gap:7px;padding-bottom:6px;color:#ceb8ad;font-size:12px;white-space:nowrap;cursor:pointer}.p2pf-adjust input{accent-color:#a44e2d}.p2pf-adjust.disabled{opacity:.45;cursor:not-allowed}.p2pf-summary{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));overflow:hidden;border:1px solid #3d281f;border-radius:8px;background:#100b09}.p2pf-summary>div{display:grid;grid-template-columns:1fr;gap:4px 12px;padding:12px 16px;border-right:1px solid #302019}.p2pf-summary>div:last-child{border-right:0}.p2pf-summary span{grid-column:1/-1;color:#ceb7ad;font-size:9.5px;letter-spacing:.12em;text-transform:uppercase}.p2pf-summary strong{color:#f0ded5;font-size:22px;letter-spacing:-.03em}.p2pf-summary em{color:#cab8b1;font-size:12px;font-style:normal;text-align:left}.p2pf-summary em.gain{color:#92ca8d}.p2pf-summary em.loss{color:#eaaea3}.p2pf-grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(440px,1fr));gap:12px}.p2pf-card{min-width:0;overflow:hidden;border:1px solid #45291f;border-top:2px solid var(--tone);border-radius:8px;background:linear-gradient(150deg,rgba(255,255,255,.015),transparent 45%),#110c0a}.p2pf-card>header{display:flex;align-items:flex-start;justify-content:space-between;gap:14px;padding:15px 16px 7px}.p2pf-card>header>div:first-child{display:grid;grid-template-columns:auto 1fr;column-gap:8px}.p2pf-rank{grid-row:1/3;align-self:center;color:#c3bbb7;font-size:12px}.p2pf-card h3{margin:0;color:#ead7ce;font-size:19px}.p2pf-card header em{color:#c5bab5;font-size:11.5px;font-style:normal}.p2pf-value{display:grid;text-align:right}.p2pf-value strong{color:#f0d8cb;font-size:17px}.p2pf-value span{font-size:11px}.gain{color:#92ca8d}.loss{color:#eaaea3}.p2pf-badges{display:flex;flex-wrap:wrap;gap:5px;padding:0 16px 5px}.p2pf-badges span{padding:3px 6px;border:1px solid #3c2921;border-radius:999px;background:#17100d;color:#c7b9b3;font-size:9.5px}.p2pf-badges .thin{border-color:#7b382d;color:#ebada2}.p2pf-badges .limited{border-color:#765428;color:#dbb681}.p2pf-badges .active,.p2pf-badges .deep{border-color:#355c3a;color:#96c999}.p2pf-badges .gain{border-color:#355c3a;color:#96c999}.p2pf-badges .loss{border-color:#7b382d;color:#ebada2}.p2pf-chart{height:140px;margin:0 6px}.p2pf-chart-empty{display:grid;height:140px;padding:12px;place-items:center;text-align:center;color:#c2bab7;font-size:12px}.p2pf-note{margin:0;padding:6px 16px 0;color:#c3bbb7;font-size:10.5px;line-height:1.45}.p2pf-card footer{display:grid;grid-template-columns:repeat(auto-fit,minmax(210px,1fr));gap:16px;padding:11px 16px 14px;margin-top:9px;border-top:1px solid #302019;color:#c3bbb6;font-size:10.5px}.p2pf-movers{display:grid;align-content:start;gap:5px;min-width:0}.p2pf-movers>span,.p2pf-uniques>span{color:#ceb7ad;font-size:9px;letter-spacing:.11em;text-transform:uppercase}.p2pf-movers ul{display:grid;gap:3px;margin:0;padding:0;list-style:none}.p2pf-movers li{display:grid;grid-template-columns:minmax(0,1fr) auto auto auto;gap:8px;align-items:baseline}.p2pf-movers li i{font-style:normal;font-size:9.5px;text-align:right;min-width:34px;color:#c2bab7}.p2pf-movers li i.gain{color:#92ca8d}.p2pf-movers li i.loss{color:#eaaea3}.p2pf-movers li span{overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:#ccb8b0;font-size:10.5px}.p2pf-movers li b{color:#d8bfb3;font-size:10.5px;font-weight:600}.p2pf-movers li em{font-style:normal;font-size:10px;text-align:right}.p2pf-movers li em.thin{color:#ebada2}.p2pf-movers li em.limited{color:#dbb681}.p2pf-movers li em.active{color:#96c999}.p2pf-movers li em.unknown{color:#c2bab7}.p2pf-uniques{display:grid;gap:7px;min-width:0}.p2pf-unique-tile{padding:8px;border:1px solid #35251e;border-radius:6px;background:linear-gradient(120deg,#17100d,#100b09)}.p2pf-unique-main{display:grid;gap:4px;min-width:0}.p2pf-unique-title{display:flex;align-items:baseline;justify-content:space-between;gap:8px}.p2pf-unique-title strong{overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:#dbc5ba;font-size:11.5px}.p2pf-unique-title b{flex-shrink:0;color:#efc5b3;font-size:11.5px;font-weight:600}.p2pf-unique-meta,.p2pf-unique-delta{display:flex;justify-content:space-between;gap:8px}.p2pf-unique-meta span{color:#c2bab7;font-size:9px}.p2pf-unique-meta .thin{color:#ebada2}.p2pf-unique-meta .limited{color:#dbb681}.p2pf-unique-meta .active,.p2pf-unique-meta .deep{color:#96c999}.p2pf-relative{position:relative;height:5px;overflow:hidden;border-radius:999px;background:#2a1c16}.p2pf-relative i{display:block;height:100%;border-radius:999px;background:linear-gradient(90deg,var(--tone),#e08a62)}.p2pf-relative b{position:absolute;top:-2px;bottom:-2px;left:25%;width:1px;background:#f0d7ca;opacity:.7}.p2pf-unique-delta span,.p2pf-unique-delta em{font-size:9.5px}.p2pf-unique-delta span{color:#c9b9b3}.p2pf-unique-delta em{font-style:normal;text-align:right}.p2pf-pool{padding:0 16px 14px}.p2pf-pool-toggle{width:100%;padding:6px 9px;border:1px solid #3c2921;border-radius:5px;background:#17100d;color:#ccb8b1;font:inherit;font-size:10.5px;cursor:pointer}.p2pf-pool-toggle:hover{border-color:#7b3e24;color:#e4b49e}.p2pf-pool-scroll{max-height:320px;overflow:auto;margin-top:8px;border:1px solid #302019;border-radius:6px}.p2pf-pool-table{width:100%;border-collapse:collapse;font-size:10.5px}.p2pf-pool-table th{position:sticky;top:0;z-index:1;padding:0;background:#17100d;text-align:right}.p2pf-pool-table th:first-child{text-align:left}.p2pf-pool-table th button{width:100%;padding:6px 8px;border:0;border-bottom:1px solid #3c2921;background:transparent;color:#ceb7ad;font:inherit;font-size:9px;letter-spacing:.09em;text-transform:uppercase;text-align:inherit;cursor:pointer}.p2pf-pool-table th button:hover{color:#e4b49e}.p2pf-pool-table td{padding:4px 8px;border-bottom:1px solid #241812;color:#ccb8b0;text-align:right;white-space:nowrap}.p2pf-pool-table td:first-child{max-width:190px;overflow:hidden;text-overflow:ellipsis;text-align:left}.p2pf-pool-table tbody tr:last-child td{border-bottom:0}.p2pf-pool-table tbody tr:hover td{background:#17100d}.p2pf-pool-table .thin{color:#ebada2}.p2pf-pool-table .limited{color:#dbb681}.p2pf-pool-table .active{color:#96c999}.p2pf-pool-table .gain{color:#92ca8d}.p2pf-pool-table .loss{color:#eaaea3}.p2pf-ranges{display:grid;grid-template-columns:repeat(6,minmax(0,1fr));gap:3px}.p2pf-unique-details summary{padding:10px 0;color:#d7b5a0;font-size:12px;cursor:pointer}.p2pf-unique-details summary span{margin-left:6px;padding:2px 6px;border-radius:5px;background:#39251a}.p2pf-unique-details[open] summary{margin-bottom:8px}.p2pf-empty{padding:40px;border:1px solid #3e281e;border-radius:8px;text-align:center;color:#c3bbb6}@media(max-width:1100px){.p2pf-head{align-items:flex-start;flex-direction:column}.p2pf-tools{width:100%;flex-wrap:wrap}}@media(max-width:720px){.p2pf-summary{grid-template-columns:1fr}.p2pf-summary>div{border-right:0;border-bottom:1px solid #302019}.p2pf-summary>div:last-child{border-bottom:0}}@media(max-width:520px){.p2pf-grid{grid-template-columns:1fr}.p2pf-tools{align-items:flex-start;flex-direction:column}}
...
@media(max-width:1350px) and (min-width:721px){.p2pf-head{align-items:flex-start;flex-direction:column}.p2pf-head p{max-width:850px}.p2pf-tools{width:100%;flex-wrap:wrap}.p2pf-summary{grid-template-columns:repeat(2,minmax(0,1fr))}.p2pf-summary>div:nth-child(2){border-right:0}.p2pf-summary>div:nth-child(-n+2){border-bottom:1px solid #302019}}
.p2pf-grid{grid-template-columns:repeat(auto-fill,minmax(min(100%,480px),1fr))}.p2pf-card>header{padding-bottom:10px}.p2pf-verdict{display:grid;text-align:right}.p2pf-verdict span{color:#c2bab7;font-size:9px;letter-spacing:.1em;text-transform:uppercase}.p2pf-verdict strong{font-size:11.5px}.p2pf-verdict.gain strong{color:#92ca8d}.p2pf-verdict.loss strong{color:#eaaea3}.p2pf-verdict.flat strong{color:#dbb681}.p2pf-decision{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));margin:0 16px 9px;overflow:hidden;border:1px solid #412b22;border-radius:7px;background:#0d0908}.p2pf-decision>div{display:grid;align-content:start;min-width:0;gap:3px;padding:10px 11px;border-right:1px solid #35231c}.p2pf-decision>div:last-child{border-right:0}.p2pf-decision span{color:#ccb8b1;font-size:8.5px;font-weight:700;letter-spacing:.1em;text-transform:uppercase}.p2pf-decision strong{overflow:hidden;color:#f0d8cb;font-size:16px;font-variant-numeric:tabular-nums;text-overflow:ellipsis;white-space:nowrap}.p2pf-decision small{color:#c8b9b1;font-size:11px;line-height:1.45}.p2pf-decision strong.gain,.p2pf-decision small.gain{color:#92ca8d}.p2pf-decision strong.loss,.p2pf-decision small.loss{color:#eaaea3}@media(max-width:720px){.p2pf-summary{grid-template-columns:1fr}.p2pf-summary>div{border-right:0;border-bottom:1px solid #302019}.p2pf-summary>div:last-child{border-bottom:0}.p2pf-grid{grid-template-columns:1fr}}@media(max-width:620px){.p2pf-decision{grid-template-columns:repeat(2,minmax(0,1fr))}.p2pf-decision>div:nth-child(2){border-right:0}.p2pf-decision>div:nth-child(-n+2){border-bottom:1px solid #35231c}}
`;
