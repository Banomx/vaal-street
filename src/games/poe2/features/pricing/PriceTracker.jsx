...
const css = `
.p2pt-main{display:grid;gap:14px}.p2pt-head{padding:20px 22px;border:1px solid #3e201f;border-radius:8px;background:linear-gradient(105deg,#170e0d,#0d0908)}.p2pt-head>div>span,.p2pt-card-head>div>span,.p2pt-stats span{color:#e2e2e0;font-size:12.5px;font-weight:700;letter-spacing:.12em;text-transform:uppercase}.p2pt-head h2{margin:4px 0;color:#e2e2e0;font-size:27px}.p2pt-head p{margin:0;color:#e2e2e0;font-size:13.5px}.p2pt-workspace{display:grid;grid-template-columns:minmax(340px,400px) minmax(0,1fr);gap:14px;align-items:start}.p2pt-card{display:grid;gap:12px;min-width:0;padding:20px;border:1px solid #4a2321;border-radius:8px;background:#110c0a}.p2pt-card-head{display:flex;justify-content:space-between;gap:20px}.p2pt-card h3{margin:4px 0;color:#e2e2e0;font-size:21px}.p2pt-card-head p{margin:0;color:#e2e2e0;font-size:12.5px}.p2pt-stats{display:flex;gap:24px;text-align:right}.p2pt-stats div{display:grid;align-content:start;gap:5px}.p2pt-stats strong{color:#e2e2e0;font-size:18px}.p2pt-ranges{display:flex;gap:5px}.p2pt-ranges button{padding:6px 10px;border:1px solid #452120;border-radius:4px;background:#160c0b;color:#e2e2e0;cursor:pointer}.p2pt-ranges button.on{border-color:#a43431;background:#2a0f0e;color:#efa29f}.p2pt-chart{min-height:300px;border-top:1px solid #301a1a;border-bottom:1px solid #301a1a}.p2pt-empty{display:grid;min-height:300px;place-items:center;color:#e2e2e0;font-size:13px}.p2pt-card footer{color:#e2e2e0;font-size:12.5px}.gain{color:#e2e2e0!important}.loss{color:#e2e2e0!important}@media(max-width:1100px){.p2pt-card-head{align-items:stretch;flex-direction:column}.p2pt-stats{justify-content:space-between;text-align:left}}@media(max-width:780px){.p2pt-workspace{grid-template-columns:1fr}.p2pt-workspace>.p2mb-browser.sticky{position:static}}@media(max-width:500px){.p2pt-stats{gap:12px}}
.p2pt-chart-tools{display:flex;align-items:center;justify-content:space-between;gap:12px}.p2pt-adjust{display:flex;align-items:center;gap:7px;color:#e2e2e0;font-size:12.5px;cursor:pointer}.p2pt-adjust input{accent-color:#a43431}.p2pt-adjust.disabled{opacity:.45;cursor:not-allowed}@media(max-width:500px){.p2pt-chart-tools{align-items:flex-start;flex-direction:column}}
`;
