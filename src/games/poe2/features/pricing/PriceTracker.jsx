...
const css = `
.p2pt-main{display:grid;gap:14px}.p2pt-head{padding:20px 22px;border:1px solid #3e281e;border-radius:8px;background:linear-gradient(105deg,#17100d,#0d0908)}.p2pt-head>div>span,.p2pt-card-head>div>span,.p2pt-stats span{color:#deb3a2;font-size:10.5px;font-weight:700;letter-spacing:.12em;text-transform:uppercase}.p2pt-head h2{margin:4px 0;color:#f0ded5;font-size:27px}.p2pt-head p{margin:0;color:#c7bab5;font-size:13.5px}.p2pt-workspace{display:grid;grid-template-columns:minmax(340px,400px) minmax(0,1fr);gap:14px;align-items:start}.p2pt-card{display:grid;gap:12px;min-width:0;padding:20px;border:1px solid #4a2b20;border-radius:8px;background:#110c0a}.p2pt-card-head{display:flex;justify-content:space-between;gap:20px}.p2pt-card h3{margin:4px 0;color:#ead5cb;font-size:21px}.p2pt-card-head p{margin:0;color:#c5bab5;font-size:12px}.p2pt-stats{display:flex;gap:24px;text-align:right}.p2pt-stats div{display:grid;align-content:start;gap:5px}.p2pt-stats strong{color:#e9d7ce;font-size:18px}.p2pt-ranges{display:flex;gap:5px}.p2pt-ranges button{padding:6px 10px;border:1px solid #45291f;border-radius:4px;background:#160e0b;color:#c8b9b3;cursor:pointer}.p2pt-ranges button.on{border-color:#a44e2d;background:#2a140d;color:#efb59d}.p2pt-chart{min-height:300px;border-top:1px solid #302019;border-bottom:1px solid #302019}.p2pt-empty{display:grid;min-height:300px;place-items:center;color:#c3bbb6;font-size:13px}.p2pt-card footer{color:#c3bbb6;font-size:11.5px}.gain{color:#92ca8d!important}.loss{color:#eaada9!important}@media(max-width:1100px){.p2pt-card-head{align-items:stretch;flex-direction:column}.p2pt-stats{justify-content:space-between;text-align:left}}@media(max-width:780px){.p2pt-workspace{grid-template-columns:1fr}.p2pt-workspace>.p2mb-browser.sticky{position:static}}@media(max-width:500px){.p2pt-stats{gap:12px}}
.p2pt-chart-tools{display:flex;align-items:center;justify-content:space-between;gap:12px}.p2pt-adjust{display:flex;align-items:center;gap:7px;color:#ceb8ad;font-size:12px;cursor:pointer}.p2pt-adjust input{accent-color:#a44e2d}.p2pt-adjust.disabled{opacity:.45;cursor:not-allowed}@media(max-width:500px){.p2pt-chart-tools{align-items:flex-start;flex-direction:column}}
`;
