...
const css = `
.p2ov-signal header{padding:18px;border-bottom:1px solid #39271f}.p2ov-signal header h3{margin:0;font-size:15px}.p2ov-signal header p,.p2ov-shortlist-empty{margin:5px 0 0;color:#ac9588;font-size:12px}.p2ov-signal em.gain{color:#79bd72}.p2ov-signal em.loss{color:#d9705c}.p2ov-signal button:hover{background:#281810}.p2ov-shortlist-empty{padding:18px;}
...
.p2ov-desk header{flex-direction:column-reverse;gap:7px}.p2ov-desk h3{font-size:19px}.p2ov-desk>p{color:#b6a092;line-height:1.55}
