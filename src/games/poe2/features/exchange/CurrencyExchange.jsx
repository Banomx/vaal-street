...
.p2ex-route-legend>span{flex:0 0 auto;padding:3px 6px;border:1px solid #9a5034;border-radius:3px;background:#2b160f;color:#efad90;font-size:12.5px;font-weight:700;letter-spacing:.08em;text-transform:uppercase}
...
.p2ex-route-name em{flex:0 0 auto;padding:2px 5px;border:1px solid #8d4b34;border-radius:3px;background:#2a160f;color:#ebae94;font-size:12.5px;font-style:normal;font-weight:700;letter-spacing:.07em;text-transform:uppercase}
...
.p2ex-market-picker{position:sticky;top:12px;min-width:0}.p2ex-market-picker-toggle{display:none}.p2ex-market-picker-body>.p2mb-browser{width:100%}.p2ex-router-controls{grid-template-columns:repeat(4,minmax(120px,1fr))}.p2ex-confidence-tags{display:flex;flex-wrap:wrap;gap:4px;margin-top:5px}.p2ex-confidence,.p2ex-confidence-tags span{display:block;width:max-content;max-width:100%;padding:4px 7px;border:1px solid #3d503a;border-radius:4px;background:#111a12;color:#e2e2e0;font-size:12.5px;font-style:normal;line-height:1.2}.p2ex-confidence.medium,.p2ex-confidence-tags span.medium{border-color:#6b522d;background:#1b160e;color:#d9b784}.p2ex-confidence.low,.p2ex-confidence-tags span.low{border-color:#71372f;background:#1d100e;color:#e2e2e0}.p2ex-route-confidence.high{border-color:#3d6841;background:#142017;color:#e2e2e0}.p2ex-route-confidence.medium{border-color:#765428;background:#21180d;color:#dbb681}.p2ex-route-confidence.low{border-color:#7b382d;background:#24110e;color:#e2e2e0}.p2ex-router-note strong{color:#dbb681}.p2ex-scanner-head{display:flex;align-items:end;justify-content:space-between;gap:18px}.p2ex-scanner-head>div>span{color:#e8af99;font-size:12.5px;font-weight:700;letter-spacing:.12em;text-transform:uppercase}.p2ex-scanner-head h3{margin:4px 0;color:#e2e2e0;font-size:20px}.p2ex-scanner-head p{max-width:760px;margin:0;color:#e2e2e0;font-size:12.5px}.p2ex-scanner-head>strong{flex:0 0 auto;color:#e2e2e0;font-size:13px}.p2ex-filters{grid-template-columns:minmax(180px,1fr) repeat(3,minmax(150px,190px))}.p2ex-gap.high{color:#e2e2e0}.p2ex-gap.medium{color:#dbb681}.p2ex-gap.low{color:#e2e2e0}.p2ex-gap small{font-weight:400}.p2ex-table-wrap th:last-child,.p2ex-table-wrap td:last-child{padding-right:14px}
...
@media(max-width:780px){.p2ex-market-picker{position:static}.p2ex-market-picker.collapsed{position:sticky;top:0;z-index:5}.p2ex-market-picker-toggle{display:grid;grid-template-columns:minmax(0,1fr) auto;align-items:center;gap:2px 12px;padding:11px 12px;border:1px solid #4a2b20;border-radius:7px;background:rgba(17,12,10,.96);box-shadow:0 9px 24px #0008;backdrop-filter:blur(4px)}.p2ex-market-picker-toggle span{color:#e2e2e0;font-size:12.5px;letter-spacing:.1em;text-transform:uppercase}.p2ex-market-picker-toggle strong{overflow:hidden;color:#e2e2e0;font-size:13px;text-overflow:ellipsis;white-space:nowrap}.p2ex-market-picker-toggle button{grid-column:2;grid-row:1/3;padding:7px 9px;border:1px solid #633b29;border-radius:4px;background:#21130e;color:#e2e2e0;cursor:pointer}.p2ex-market-picker-body{margin-top:7px}.p2ex-market-picker.collapsed .p2ex-market-picker-body{display:none}.p2ex-router{scroll-margin-top:62px}}
