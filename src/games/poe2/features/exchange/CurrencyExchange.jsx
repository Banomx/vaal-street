...
.p2ex-market-picker{position:sticky;top:12px;min-width:0}.p2ex-market-picker-toggle{display:none}.p2ex-market-picker-body>.p2mb-browser{width:100%}.p2ex-router-controls{grid-template-columns:repeat(4,minmax(120px,1fr))}.p2ex-confidence-tags{display:flex;flex-wrap:wrap;gap:4px;margin-top:5px}.p2ex-confidence,.p2ex-confidence-tags span{display:block;width:max-content;max-width:100%;padding:4px 7px;border:1px solid #3d503a;border-radius:4px;background:#111a12;color:#91c98b;font-size:8.5px;font-style:normal;line-height:1.2}.p2ex-confidence.medium,.p2ex-confidence-tags span.medium{border-color:#6b522d;background:#1b160e;color:#d0a565}.p2ex-confidence.low,.p2ex-confidence-tags span.low{border-color:#71372f;background:#1d100e;color:#de756b}.p2ex-route-confidence.high{border-color:#3d6841;background:#142017;color:#8dcc88}.p2ex-route-confidence.medium{border-color:#765428;background:#21180d;color:#d2a563}.p2ex-route-confidence.low{border-color:#7b382d;background:#24110e;color:#e18272}.p2ex-router-note strong{color:#d2a563}.p2ex-scanner-head{display:flex;align-items:end;justify-content:space-between;gap:18px}.p2ex-scanner-head>div>span{color:#d56e44;font-size:10px;font-weight:700;letter-spacing:.12em;text-transform:uppercase}.p2ex-scanner-head h3{margin:4px 0;color:#ead5cb;font-size:20px}.p2ex-scanner-head p{max-width:760px;margin:0;color:#8e776d;font-size:11px}.p2ex-scanner-head>strong{flex:0 0 auto;color:#d9b6a5;font-size:13px}.p2ex-filters{grid-template-columns:minmax(180px,1fr) repeat(3,minmax(150px,190px))}.p2ex-gap.high{color:#79bd72}.p2ex-gap.medium{color:#d2a563}.p2ex-gap.low{color:#dc716c}.p2ex-gap small{font-weight:400}.p2ex-table-wrap th:last-child,.p2ex-table-wrap td:last-child{padding-right:14px}
