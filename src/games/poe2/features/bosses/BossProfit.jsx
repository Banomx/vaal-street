...
.p2-override-bar { display:flex; align-items:center; justify-content:space-between; gap:12px; min-height:39px; color:#c6bab5; font-size:12.5px; }.p2-override-bar button { padding:7px 12px; border:1px solid #65351f; border-radius:5px; background:#17100d; color:#cdb8b0; font:inherit; font-size:12.5px; cursor:pointer; }.p2-override-bar button:hover:not(:disabled) { color:#f0e4de; border-color:#bd461d; }.p2-override-bar button:disabled { opacity:.42; cursor:default; }
.p2-price-coverage { display:grid; gap:10px; padding:15px 17px; border:1px solid #3c5335; border-radius:7px; background:linear-gradient(100deg,#111a0e,#100d0b); }.p2-price-coverage>div{display:grid;gap:3px}.p2-price-coverage small{color:#a1c69c;font-size:11px;letter-spacing:.14em}.p2-price-coverage strong{color:#d8e5cf;font-size:15.5px}.p2-price-coverage p{margin:0;color:#b5c0ae;font-size:13.5px;line-height:1.45}.p2-price-coverage.warning{border-color:#6d3e22;background:linear-gradient(100deg,#24130d,#130e0c)}.p2-price-coverage.warning small{color:#f5ac84}.p2-price-coverage.warning strong{color:#f1dfd5}.p2-price-coverage.warning p{color:#cab8b1}.p2-price-coverage details{border-top:1px solid #4b3024;padding-top:8px}.p2-price-coverage summary{width:max-content;color:#e3b296;font-size:12.5px;cursor:pointer}.p2-price-coverage ul{display:grid;grid-template-columns:repeat(auto-fit,minmax(260px,1fr));gap:5px 12px;margin:10px 0 0;padding:0;list-style:none}.p2-price-coverage li{display:grid;gap:2px;padding:7px 9px;border:1px solid #3d291f;border-radius:5px;background:#120d0b}.p2-price-coverage li strong{color:#d8c2b7;font-size:12.5px}.p2-price-coverage li span{color:#c5bab4;font-size:11px;line-height:1.35}
.p2-boss-detail > header a { flex:0 0 auto; padding:8px 11px; border:1px solid #754326; border-radius:5px; background:#20140f; color:#d7b6a4; font:inherit; font-size:12.5px; cursor:pointer; text-decoration:none; }
.p2-ttk-banner { display:flex; align-items:center; justify-content:space-between; gap:18px; padding:15px 17px; border:1px solid #3d3d27; border-radius:7px; background:linear-gradient(100deg,#17160d,#100d0b); }.p2-ttk-banner>div:first-child{display:grid;gap:3px}.p2-ttk-banner small,.p2-profile-editor small{color:#c7bd8a;font-size:11px;letter-spacing:.14em}.p2-ttk-banner strong{color:#e4dcc2;font-size:15.5px}.p2-ttk-banner p{margin:0;color:#c1bca7;font-size:13.5px}.p2-ttk-actions{display:flex;gap:7px}.p2-ttk-actions button,.p2-profile-editor button{padding:9px 11px;border:1px solid #615a2e;border-radius:5px;background:#1b190d;color:#d4ca92;font:inherit;font-size:13px;cursor:pointer}
...
.p2-boss-list-head { display:flex; justify-content:space-between; gap:12px; padding:10px 13px; border-bottom:1px solid #3a251c; color:#c3bab5; font-size:10.5px; font-weight:700; letter-spacing:.13em; text-transform:uppercase; }
...
.p2-boss-rank-meta { display:flex; flex-wrap:wrap; align-items:center; gap:5px 7px; margin:4px 0 6px 15px; color:#c4bab5; font-size:12px; line-height:1.45; }.p2-boss-rank-meta em { padding:1px 4px; border:1px solid #754326; border-radius:3px; color:#e9af92; font-size:10.5px; font-style:normal; }
...
.p2-boss-rank-value { flex:0 0 auto; color:#a5d48f; font-size:15px; font-weight:700; font-variant-numeric:tabular-nums; white-space:nowrap; }.p2-boss-rank-value.loss { color:#e4afaf; }
...
.p2-ok { color:#9ec6a1; }.muted { color:#c3bbb7!important; }.gain { color:#92ca8d; }.loss { color:#eeaca5; }
.p2-boss-detail { padding:0 0 16px; border:1px solid #4b2d20; border-radius:8px; background:#0e0a08; }.p2-boss-detail > header { display:flex; align-items:start; justify-content:space-between; gap:15px; padding:15px 17px; border-bottom:1px solid #35241d; }.p2-boss-detail h2 { margin:8px 0 2px; color:#f2dfd5; font-size:24px; font-weight:600; }.p2-boss-detail header p { margin:0; color:#c6bab5; font-size:13.5px; }
.p2-ev-cards { display:grid; grid-template-columns:repeat(4,minmax(0,1fr)); gap:10px; padding:15px 17px 5px; }.p2-ev-cards > div { min-height:94px; padding:12px 13px; border:1px solid #35241c; border-radius:6px; background:#15100d; }.p2-ev-cards small { color:#c4bab5; font-size:10.5px; letter-spacing:.11em; }.p2-ev-cards strong { display:block; margin:5px 0 3px; color:#e9d7cc; font-size:21px; }.p2-ev-cards p { margin:0; color:#c5bab5; font-size:12.5px; line-height:1.35; }
.p2-detail-timing { display:flex; flex-wrap:wrap; align-items:center; gap:12px; padding:11px 17px 9px; color:#c6bab5; font-size:13.5px; }.p2-detail-timing label { display:flex; align-items:center; gap:8px; color:#cbb8af; }.p2-detail-timing span { color:#c4bab5; }
.p2-entry-lines { display:flex; flex-wrap:wrap; align-items:center; gap:7px; margin:0 17px 4px; color:#c8b9b3; font-size:13.5px; }.p2-entry-lines > strong { color:#cfb7ab; margin-right:4px; }.p2-entry-lines span { padding:6px 8px; border:1px solid #37251d; border-radius:5px; }.p2-entry-lines em { color:#dfb397; font-style:normal; }
.p2-gamble-note { display:flex; align-items:flex-start; gap:9px; margin:8px 17px 0; padding:9px 11px; border:1px solid #5d4826; border-radius:5px; background:#171309; color:#c6bba4; font-size:12.5px; line-height:1.45; }.p2-gamble-note strong{flex:0 0 auto;color:#dfbd63}.p2-gamble{display:inline-flex;margin-left:6px;padding:2px 5px;border:1px solid #80682d;border-radius:4px;background:#241e0b;color:#e4bf50;font-size:9.5px;letter-spacing:.06em;text-transform:uppercase;vertical-align:2px;cursor:help}
.p2-drop-grid { display:grid; grid-template-columns:repeat(auto-fit,minmax(min(100%,520px),1fr)); gap:12px; padding:11px 17px 0; align-items:start; }.p2-drop-group { min-width:0; overflow:hidden; border:1px solid #35241d; border-radius:7px; }.p2-drop-group > header { display:flex; justify-content:space-between; gap:12px; padding:12px 14px; background:#17110e; }.p2-drop-group h3 { margin:0; color:#d9c1b5; font-size:15.5px; }.p2-drop-group header p { margin:3px 0 0; color:#cbb8af; font-size:12px; line-height:1.4; }.p2-drop-group > header > strong { color:#e3b38f; font-size:14px; white-space:nowrap; }
.p2-drop-table-wrap { min-width:0; overflow:hidden; }.p2-drop-table { width:100%; min-width:0; border-collapse:collapse; table-layout:fixed; font-size:13.5px; }.p2-drop-table th { padding:9px 8px; color:#c3bbb7; font-size:10px; line-height:1.25; letter-spacing:.08em; text-align:left; text-transform:uppercase; white-space:normal; }.p2-drop-table td { min-width:0; padding:9px 8px; border-top:1px solid #271b16; color:#ceb8ad; overflow-wrap:anywhere; }.p2-drop-table th:nth-child(1){width:40%}.p2-drop-table th:nth-child(2){width:20%}.p2-drop-table th:nth-child(3){width:20%}.p2-drop-table th:nth-child(4){width:20%}.p2-drop-table td:first-child strong { color:#e7d2c8; }.p2-drop-table td:first-child small { color:#c7b9b3; font-size:12px; }.p2-rarity,.p2-price-proxy { display:block; }.p2-info { display:inline-grid; width:16px; height:16px; margin-left:5px; place-items:center; border:1px solid #6e4b3d; border-radius:50%; color:#d6b6a6; font-size:10.5px; line-height:1; vertical-align:2px; cursor:help; }
.p2-rate-input,.p2-price-edit { display:inline-flex; max-width:100%; align-items:center; justify-content:flex-end; gap:3px; }.p2-rate-input input,.p2-price-edit input { width:min(62px,calc(100% - 14px)); min-width:42px; padding:4px 5px; border:1px solid #7d4023; border-radius:4px; background:#0d0907; color:#f2c1a7; font:inherit; text-align:right; }.p2-rate-input em,.p2-price-edit em,.p2-rate em { color:#c6bab4; font-style:normal; }.p2-rate,.p2-price { display:inline-grid; max-width:100%; justify-items:end; padding:0; border:0; background:none; color:#ddb494; font:inherit; overflow-wrap:anywhere; cursor:pointer; }.p2-rate { display:inline-flex; gap:3px; }.p2-rate:hover,.p2-price:hover { color:#f0c3a6; text-decoration:underline dotted; }.p2-price.missing { color:#dcb3a3; text-decoration:underline dotted; }.p2-price.manual { color:#96c89d; }.p2-price small { color:#aec1b1; font-size:9px; }
.p2-model-note { margin:15px 17px 0; color:#c5bab5; font-size:13px; line-height:1.55; }.p2-empty-result { padding:25px 12px; color:#c5bab5; font-size:13.5px; text-align:center; }
